...
public class Web3jWrapperNoneZeroStatusMock implements Web3jWrapper {
    ...
    public Call.CallOutput call(String contractAddress, String data) throws IOException {
        ...
        callOutput.setCurrentBlockNumber("0x1112");
        callOutput.setStatus("0x16"); // revert instruction
